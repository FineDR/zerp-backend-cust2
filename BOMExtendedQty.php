...
if (isset($_POST['PrintPDF']) or isset($_POST['View'])) {
    ...
    if (isset($_POST['PrintPDF'])) {
        ...
        echo '<style>
            :root { --primary: hsl(145, 63%, 38%); --primary-hover: hsl(145, 63%, 32%); --primary-dark: hsl(145, 45%, 22%); --primary-soft: hsl(145, 40%, 95%); --bg-workspace: hsl(210, 20%, 97%); --border-color: hsl(220, 15%, 88%); --danger: #e11d48; --danger-soft: #fff1f2; }
