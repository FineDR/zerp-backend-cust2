...
<div class="db-page">
    ...
    <div class="db-page-header">
        ...
        <div class="db-header-actions">
            ...
            <a href="<?= $RootPath ?>/SupplierAging.php" class="db-btn db-btn-secondary">
            ...
            <a href="<?= $RootPath ?>/CustomerAging.php" class="db-btn db-btn-secondary">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><line x1="18" y1="20" x2="18" y2="10"></line><line x1="12" y1="20" x2="12" y2="4"></line><line x1="6" y1="20" x2="6" y2="14"></line></svg>
                <?= __('Aged Debtors') ?>
            </a>
            <a href="<?= $RootPath ?>/SupplierPayment.php" class="db-btn db-btn-secondary">
