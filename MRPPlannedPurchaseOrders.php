...
if (isset($_POST['PrintPDF']) or isset($_POST['View'])) {
	...
	if (isset($_POST['PrintPDF'])) {
        ...
        echo '<style>
            ...
            .db-report-table .number { text-align: right; }
            ...
            <div class="db-centered">
                <div class="db-page-header">
                    <div>
                        ...
                        <h1 class="db-page-title">' . __('Planned Purchase Orders') . '</h1>
                    </div>
        ...
        $HTML = str_replace('<td class="number">', '<td class="number db-mono">', $HTML);
        $HTML = str_replace('<h2>', '', $HTML);
        $HTML = str_replace('<div style="text-align:center; margin-bottom: 10px;">', '<div style="padding: 1rem 1.5rem; font-size: 0.8125rem; font-weight:600; color:var(--db-text-muted); border-bottom:1px solid var(--db-border);">', $HTML);
            ...
            <div class="db-main-grid">
                ...
                <div class="db-field-group">
                    <div class="db-info-box">
                        ...
                        ' . __('This report list all the parts that the MRP calculation has determined should have purchase orders created for them.') . '
                        <ul style="margin: 1rem 0 0 1.5rem; padding:0;">
                            <li>' . __('Consolidation allows grouping requirements together by week or month.') . '</li>
                            <li>' . __('The "Cut Off Date" filters orders due on or before that date.') . '</li>
                        </ul>
                    </div>
                </div>
