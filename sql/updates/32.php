...
*/
ChangeColumnSize('password', 'emailsettings', 'VARCHAR(99)', ' NOT NULL ', '', '99');
UpdateDBNo(basename(__FILE__, '.php'), __('Increase the potential size of the SMPT server password to 99 chars'));