...
$Description = 'This function is used to print a new AgedDebtors report.';
$Parameter[0]['name'] = __('Array of Report filter criteria');
$Parameter[0]['description'] = __('A set of key/value pairs where the key must be identical to the name of the field to be updated. ')
	. __('The field names can be found ') . '<a href="../../Z_DescribeTable.php?table=salesorders">' . __('here ') . '</a>'
	. __('and are case sensitive. ') . __('The values should be of the correct type, and the api will check them before updating the database. ')
	. __('The orderno key is generated by this call, and if a value is supplied, it will be ignored. ')
	. __('It is not necessary to include all the fields in this parameter, the database default value will be used if the field is not given.');
$Parameter[1]['name'] = __('Array of Customers filter criteria');
$Parameter[1]['description'] = __('A set of key/value pairs where the key must be identical to the name of the field to be updated. ')
	. __('The field names can be found ') . '<a href="../../Z_DescribeTable.php?table=salesorders">' . __('here ') . '</a>'
	. __('and are case sensitive. ') . __('The values should be of the correct type, and the api will check them before updating the database. ')
	. __('The orderno key is generated by this call, and if a value is supplied, it will be ignored. ')
	. __('It is not necessary to include all the fields in this parameter, the database default value will be used if the field is not given.');
...
$GetAgedDebtors_doc = apiBuildDocHTML($Description, $Parameter, $ReturnValue);

function xmlrpc_GetAgedDebtors($request)
{
	ob_start('ob_file_callback');
	$encoder = new Encoder();
	if ($request->getNumParams() == 4) {
		$rtn = new Response($encoder->encode(GetAgedDebtors(
			$encoder->decode($request->getParam(0)),
			$encoder->decode($request->getParam(1)),
			$request->getParam(2)->scalarval(),
			$request->getParam(3)->scalarval())));
	} else {
		$rtn = new Response($encoder->encode(GetAgedDebtors($encoder->decode($request->getParam(0)), 
		 $encoder->decode($request->getParam(1)),'', '')));
	}
	ob_end_flush();
	return $rtn;
...
$Description = 'This function is used to start a new Supplier invoice header.';
$Parameter[0]['name'] = __('Insert Supplier Invoice Header');
$Parameter[0]['description'] = __('A set of key/value pairs where the key must be identical to the name of the field to be updated. ')
	. __('The field names can be found ') . '<a href="../../Z_DescribeTable.php?table=salesorders">' . __('here ') . '</a>'
	. __('and are case sensitive. ') . __('The values should be of the correct type, and the api will check them before updating the database. ')
	. __('The orderno key is generated by this call, and if a value is supplied, it will be ignored. ')
	. __('It is not necessary to include all the fields in this parameter, the database default value will be used if the field is not given.');
$Parameter[1]['name'] = __('Insert Supplier Invoice Header');
$Parameter[1]['description'] = __('A set of key/value pairs where the key must be identical to the name of the field to be updated. ')
	. __('The field names can be found ') . '<a href="../../Z_DescribeTable.php?table=salesorders">' . __('here ') . '</a>'
	. __('and are case sensitive. ') . __('The values should be of the correct type, and the api will check them before updating the database. ')
	. __('The orderno key is generated by this call, and if a value is supplied, it will be ignored. ')
...
$InsertSupplierInvoiceHeader_sig = array(
	array(Value::$xmlrpcArray, Value::$xmlrpcStruct, Value::$xmlrpcStruct),
	array(Value::$xmlrpcArray, Value::$xmlrpcStruct, Value::$xmlrpcStruct, Value::$xmlrpcString, Value::$xmlrpcString));
$InsertSupplierInvoiceHeader_doc = apiBuildDocHTML($Description, $Parameter, $ReturnValue);

function xmlrpc_InsertSupplierInvoiceHeader($request)
{
	ob_start('ob_file_callback');
	$encoder = new Encoder();
	if ($request->getNumParams() == 4) {
		$rtn = new Response($encoder->encode(InsertSupplierInvoiceHeader(
			$encoder->decode($request->getParam(0)),
			$encoder->decode($request->getParam(1)),
			$request->getParam(2)->scalarval(),
			$request->getParam(3)->scalarval())));
	} else {
		$rtn = new Response($encoder->encode(InsertSupplierInvoiceHeader($encoder->decode($request->getParam(0)), 
		 $encoder->decode($request->getParam(1)),'', '')));
	}
	ob_end_flush();
	return $rtn;
...
$Description = 'This function is used to start a new Supplier invoice.';
$Parameter[0]['name'] = __('Insert Supplier Invoice Header');
$Parameter[0]['description'] = __('A set of key/value pairs where the key must be identical to the name of the field to be updated. ')
	. __('The field names can be found ') . '<a href="../../Z_DescribeTable.php?table=salesorders">' . __('here ') . '</a>'
	. __('and are case sensitive. ') . __('The values should be of the correct type, and the api will check them before updating the database. ')
	. __('The orderno key is generated by this call, and if a value is supplied, it will be ignored. ')
	. __('It is not necessary to include all the fields in this parameter, the database default value will be used if the field is not given.');
$Parameter[1]['name'] = __('Insert Supplier Invoice Line');
$Parameter[1]['description'] = __('A set of key/value pairs where the key must be identical to the name of the field to be updated. ')
	. __('The field names can be found ') . '<a href="../../Z_DescribeTable.php?table=salesorders">' . __('here ') . '</a>'
	. __('and are case sensitive. ') . __('The values should be of the correct type, and the api will check them before updating the database. ')
	. __('The orderno key is generated by this call, and if a value is supplied, it will be ignored. ')
...
function xmlrpc_InsertSupplierInvoice($request)
{
	...
	if ($request->getNumParams() == 4) {
		...
		$rtn = new Response($encoder->encode(InsertSupplierInvoice($encoder->decode($request->getParam(0)), 
		 $encoder->decode($request->getParam(1)),'', '')));
	}
	ob_end_flush();
	return $rtn;
...
$Description = 'This function is used to modify the header details of a supplier invoice';
$Parameter[0]['name'] = __('Modify Sales Order Header Details');
$Parameter[0]['description'] = __('A set of key/value pairs where the key must be identical to the name of the field to be updated. ')
	. __('The field names can be found ') . '<a href="../../Z_DescribeTable.php?table=salesorders">' . __('here ') . '</a>'
	. __('and are case sensitive. ') . __('The values should be of the correct type, and the api will check them before updating the database. ')
...
$ModifySupplierInvoiceHeader_sig = array(
	array(Value::$xmlrpcArray, Value::$xmlrpcStruct),
	array(Value::$xmlrpcArray, Value::$xmlrpcStruct, Value::$xmlrpcString, Value::$xmlrpcString));
$ModifySupplierInvoiceHeader_doc = apiBuildDocHTML($Description, $Parameter, $ReturnValue);

function xmlrpc_ModifySupplierInvoiceHeader($request)
{
	ob_start('ob_file_callback');
	$encoder = new Encoder();
	if ($request->getNumParams() == 3) {
		$rtn = new Response($encoder->encode(ModifySupplierInvoiceHeader(
			$encoder->decode($request->getParam(0)),
			$request->getParam(1)->scalarval(),
			$request->getParam(2)->scalarval())));
	} else {
		$rtn = new Response($encoder->encode(ModifySupplierInvoiceHeader($encoder->decode($request->getParam(0)), '', '')));
	}
	ob_end_flush();
	return $rtn;
}
...
$Description = 'This function is used to add line items to a supplier invoice.';
$Parameter[0]['name'] = __('Insert Supplier Invoice Line');
$Parameter[0]['description'] = __('A set of key/value pairs where the key must be identical to the name of the field to be updated. ')
	. __('The field names can be found ') . '<a href="../../Z_DescribeTable.php?table=salesorderdetails">' . __('here ') . '</a>'
	. __('and are case sensitive. ') . __('The values should be of the correct type, and the api will check them before updating the database. ')
	. __('The orderno key must be one of these values. ')
...
$InsertSupplierInvoiceLine_sig = array(
	array(Value::$xmlrpcArray, Value::$xmlrpcStruct),
	array(Value::$xmlrpcArray, Value::$xmlrpcStruct, Value::$xmlrpcString, Value::$xmlrpcString));
$InsertSupplierInvoiceLine_doc = apiBuildDocHTML($Description, $Parameter, $ReturnValue);

function xmlrpc_InsertSupplierInvoiceLine($request)
{
	ob_start('ob_file_callback');
	$encoder = new Encoder();
	if ($request->getNumParams() == 3) {
		$rtn = new Response($encoder->encode(InsertSupplierInvoiceLine(
			$encoder->decode($request->getParam(0)),
			$request->getParam(1)->scalarval(),
			$request->getParam(2)->scalarval())));
	} else {
		$rtn = new Response($encoder->encode(InsertSupplierInvoiceLine($encoder->decode($request->getParam(0)), '', '')));
	}
	ob_end_flush();
	return $rtn;
}
...
$Description = 'This function is used to modify line items on a supplier invoice.';
$Parameter[0]['name'] = __('Modify Supplier Invoice Line');
$Parameter[0]['description'] = __('A set of key/value pairs where the key must be identical to the name of the field to be updated. ')
	. __('The field names can be found ') . '<a href="../../Z_DescribeTable.php?table=salesorderdetails">' . __('here ') . '</a>'
	. __('and are case sensitive. ') . __('The values should be of the correct type, and the api will check them before updating the database. ')
	. __('The orderno and stkcode keys must be one of these values. ')
...
$ModifySupplierInvoiceLine_sig = array(
	array(Value::$xmlrpcArray, Value::$xmlrpcStruct),
	array(Value::$xmlrpcArray, Value::$xmlrpcStruct, Value::$xmlrpcString, Value::$xmlrpcString));
$ModifySupplierInvoiceLine_doc = apiBuildDocHTML($Description, $Parameter, $ReturnValue);

function xmlrpc_ModifySupplierInvoiceLine($request)
{
	ob_start('ob_file_callback');
	$encoder = new Encoder();
	if ($request->getNumParams() == 3) {
		$rtn = new Response($encoder->encode(ModifySupplierInvoiceLine(
			$encoder->decode($request->getParam(0)),
			$request->getParam(1)->scalarval(),
			$request->getParam(2)->scalarval())));
	} else {
		$rtn = new Response($encoder->encode(ModifySupplierInvoiceLine($encoder->decode($request->getParam(0)), '', '')));
	}
	ob_end_flush();
	return $rtn;
}
...
$GetDebtorInvoiceDetails_sig = array(
	array(Value::$xmlrpcStruct, Value::$xmlrpcString),
	array(Value::$xmlrpcStruct, Value::$xmlrpcString, Value::$xmlrpcString, Value::$xmlrpcString));
$GetDebtorInvoiceDetails_doc = apiBuildDocHTML($Description, $Parameter, $ReturnValue);

function xmlrpc_GetDebtorInvoiceDetails($request)
{
	ob_start('ob_file_callback');
	$encoder = new Encoder();
	if ($request->getNumParams() == 3) {
		$rtn = new Response($encoder->encode(GetDebtorInvoiceDetails(
			$request->getParam(0)->scalarval(),
			$request->getParam(1)->scalarval(),
			$request->getParam(2)->scalarval())));
	} else {
		$rtn = new Response($encoder->encode(GetDebtorInvoiceDetails($request->getParam(0)->scalarval(), '', '')));
	}
	ob_end_flush();
	return $rtn;
}
...
$Description = __('This function takes a supplier ID and returns an array of key/value pairs.') .
	__('The keys represent the database field names, and the values are the value of that field.');
$Parameter[0]['name'] = __('Supplier ID');
$Parameter[0]['description'] = __('The Supplier ID to identify the supplier in the database.');
$Parameter[1]['name'] = __('User name');
$Parameter[1]['description'] = __('A valid weberp username. This user should have security access to this data.');
$Parameter[2]['name'] = __('User password');
$Parameter[2]['description'] = __('The weberp password associated with this user name. ');
$ReturnValue = __('If successful this function returns a set of key/value pairs containing the details of this order. ')
	. __('The key will be identical with field name from the tables involved in the query. All fields will be in the set regardless of whether the value was set.') . '<p>'
	. __('Otherwise an array of error codes is returned. ');

$GetSupplierInquiry_sig = array(
	array(Value::$xmlrpcStruct, Value::$xmlrpcString),
	array(Value::$xmlrpcStruct, Value::$xmlrpcString, Value::$xmlrpcString, Value::$xmlrpcString));
$GetSupplierInquiry_doc = apiBuildDocHTML($Description, $Parameter, $ReturnValue);

function xmlrpc_GetSupplierInquiry($request)
{
	ob_start('ob_file_callback');
	$encoder = new Encoder();
	if ($request->getNumParams() == 3) {
		$rtn = new Response($encoder->encode(GetSupplierInquiry(
			$request->getParam(0)->scalarval(),
			$request->getParam(1)->scalarval(),
			$request->getParam(2)->scalarval())));
	} else {
		$rtn = new Response($encoder->encode(GetSupplierInquiry($request->getParam(0)->scalarval(), '', '')));
	}
	ob_end_flush();
	return $rtn;
}
...
return array(
	...
	/////////// jlungo's APIs ///////////////////
	"weberp.xmlrpc_GetSupplierInquiry" => array(
	...
	"weberp.xmlrpc_GetDebtorInvoiceDetails" => array(
		"function" => "xmlrpc_GetDebtorInvoiceDetails",
	...
	"weberp.xmlrpc_InsertSupplierInvoiceHeader" => array(
		...
		"docstring" => $InsertSupplierInvoiceHeader_doc),
	"weberp.xmlrpc_ModifySupplierInvoiceHeader" => array(
		"function" => "xmlrpc_ModifySupplierInvoiceHeader",
		"signature" => $ModifySupplierInvoiceHeader_sig,
		"docstring" => $ModifySupplierInvoiceHeader_doc),
	"weberp.xmlrpc_InsertSupplierInvoiceLine" => array(
		"function" => "xmlrpc_InsertSupplierInvoiceLine",
		"signature" => $InsertSupplierInvoiceLine_sig,
		"docstring" => $InsertSupplierInvoiceLine_doc),
	"weberp.xmlrpc_ModifySupplierInvoiceLine" => array(
