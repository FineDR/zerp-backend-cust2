...
if (isset($_POST['PrintPDF']) or isset($_POST['View']) or isset($_POST['Email'])) {
	...
	echo '<style>
		...
		.button-group input[name="Email"] { background: var(--primary); color: white; }
	...
	$selectedAll = ($_POST['StockLocation'] == 'All') ? 'selected="selected"' : '';
	echo '<option ' . $selectedAll . ' value="All">' . __('All') . '</option>';
	while ($MyRow = DB_fetch_array($ResultStkLocs)) {
		$selected = ($MyRow['loccode'] == $_POST['StockLocation']) ? 'selected="selected"' : '';
	...
	$selectedAllCat = ($_POST['StockCat'] == 'All') ? 'selected="selected"' : '';
	echo '<option ' . $selectedAllCat . ' value="All">' . __('All') . '</option>';
